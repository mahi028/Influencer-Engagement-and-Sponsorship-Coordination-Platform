async function make_response(url, to_update, value){
    try{
        ...
        if(result['Request'] == 'liked'){
            let likes_cont = document.getElementById('likes')
            let likes = parseInt(likes_cont.innerHTML, 10) + 1
            likes_cont.innerHTML = likes
            document.getElementById('like_btn').innerHTML = `<button type="button" class="btn"  class="btn" onclick="make_response('/like/dislike/${value}', 'dislikes', '${value}')">
        ...
        }else if(result['Request'] == 'disliked'){
            let likes_cont = document.getElementById('likes')
            let likes = parseInt(likes_cont.innerHTML, 10) - 1
            likes_cont.innerHTML = likes
            document.getElementById('like_btn').innerHTML = `<button type="button" class="btn"  class="btn" onclick="make_response('/like/like/${value}', 'likes', '${value}')">
